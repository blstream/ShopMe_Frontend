...
import ScreenFirstRegister from 'screens/Register/FirstRegisterScreen/FirstRegisterScreen';
...
export default() => (
  <BrowserRouter>
    <Switch>
      ...
      <Route path="/register/first" render={wrapInLayout(ScreenFirstRegister)} />
